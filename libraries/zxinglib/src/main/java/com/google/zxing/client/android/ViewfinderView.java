...
//import com.newcapec.zxingcoretest.R;
...
public final class ViewfinderView extends View {
  ...
  public void onDraw(Canvas canvas) {
    ...
    //
    int w = 7 * width / 8; // Target 5/8 of each dimension
    int h = 7 * height / 8; // Target 5/8 of each dimension
    frame.left =  (width - w) / 2;
    frame.top =  (height - h) / 2;
